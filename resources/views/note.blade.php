            ...
            <div class="row">
                <div class="col">
                    ...
                    <small class="text-secondary"><span class="opacity-75 me-2">Created
                            at:</span><strong>{{ date('d-m-Y H:i:s')}}</strong></small>
                            @if ($note['created_at'] != $note['updated_at'])
                            <small class="text-secondary"><span class="opacity-75 me-2">Updated at:</span><strong>{{ date('d-m-Y H:i:s')}}</strong></small>
                            @endif
                </div>
